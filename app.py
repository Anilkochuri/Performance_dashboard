    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            if 'Category' in df.columns and 'ElapsedTime' in df.columns:
                bar_fig = px.bar(df, x='Category', y='ElapsedTime', title='Bar Chart')
                line_fig = px.line(df, x='Category', y='ElapsedTime', title='Line Chart')
                pie_fig = px.pie(df, names='Category', values='ElapsedTime', title='Pie Chart')
